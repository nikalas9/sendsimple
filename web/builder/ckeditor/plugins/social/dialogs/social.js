...
CKEDITOR.dialog.add( 'social', function( editor ) {
	var config = editor.config,
		lang = editor.lang.social;
    ...
    var images = config.smiley_images_one;
	for (var j in images) {
        ...
        for (var i in image) {
            ...
            html.push(
                ...
                '<a href="javascript:void(0)" role="option"', ' aria-posinset="' + ( i + 1 ) + '"', ' aria-labelledby="' + smileyLabelId + '"',
    ...
    var images = config.smiley_images_two;
    for (var j in images) {

        var image = images[j];
        html2.push( '<tr role="presentation">' );
	...
	return {
		title: editor.lang.social.title,
		minWidth: 544,
		minHeight: 400,
        resizable:false,
		contents: [ {
                id: 'tab1',
                label: '170 icons (48x48)',
                title: '170 icons (48x48)',
                expand: true,
                padding: 0,
                elements: [
                    {
            ...
            {
                id: 'tab2',
                label: 'ru icons (100x100)',
                title: 'ru icons (100x100)',
                expand: true,
                padding: 0,
                elements: [
                    {
...
CKEDITOR.config.smiley_images_one = [
...
CKEDITOR.config.smiley_images_two = [
