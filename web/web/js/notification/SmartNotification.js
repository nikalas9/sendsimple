    ...
    $.SmartMessageBox = function (settings, callback) {
        ...
        if (settings.input != undefined) {
            ...
            case "password":
                ...
                break;
            case "textarea":
                InputType = "<textarea style='width:50%' class='form-control' id='txt" +
                SmartMSGboxCount + "' placeholder='" + settings.placeholder + "'></textarea><br/><br/>";
                break;
            ...
            if (HasInput == 1) {
                ...
                if (typeof callback == "function") {
                    ...
                    if (settings.required) {
                        if( ( $.trim( Value).length == 0) && ( $($(".botTempo")[0]).attr('id') != ThisID) ) {
                            $("#txt" + IDNumber).css('background-color','#fff0f0');
                            return false;
                        }
                    }
                    if (callback)
